...
document.getElementById('parrafo').innerHTML = 'Producto:___ ' + nombre + '<br>Cantidad:___ ' + unidades + '<br>Precio por unidad: $ ' + precio + '<br>Subtotal:___ $ ' + subTotal + '<br>Descuento;___ $ ' + descuento + '<br>TOTAL con descuento: $ '+ total;